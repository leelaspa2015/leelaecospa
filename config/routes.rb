Leelaecospa::Application.routes.draw do
  ...
  match '/yoga_littlehappies', to: 'static_pages#yoga_littlehappies', via: 'get'
  ...
  match '/natural_healing', to: 'static_pages#natural_healing', via: 'get'
  match '/natural_wellness', to: 'static_pages#natural_wellness', via: 'get'
